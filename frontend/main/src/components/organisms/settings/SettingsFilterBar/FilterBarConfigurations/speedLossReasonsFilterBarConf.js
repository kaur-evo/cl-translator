...
export function createFilterConfiguration() {
  ...
  filterConfiguration.set('search', searchFilter(i18n.global.t('Speed loss reason')));
  ...
  filterConfiguration.set('groupId', groupFilter('perfComment/perfCommentGroupsWithAdminPermissions'));
